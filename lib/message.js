...
const messageFb = module.exports = {
  ...
  start: () => {
    messenger.send(
      ...
      const demqr3 = new fb.QuickReply({ title: `Imprimer`, payload: 'PRINT_MAGAZINE', image_url: `${sslRootUrl}/images/circle/print.png` });
      ...
      messenger.send(
        new fb.GenericTemplate([
          new fb.Element({
            ...
            item_url: `${sslWebUrl}/newevent/${senderId}/`,
            image_url: `${sslRootUrl}/images/square/add_photo.png`,
            subtitle: `Selection de l'image de couverture de votre publication`,
            buttons: [
              new fb.Button({ type: 'web_url', title: 'AJOUTER', url: `${sslWebUrl}/newevent/${senderId}/`, webview_height_ratio: 'full', messenger_extensions: true }),
