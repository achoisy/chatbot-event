    ...
    messenger.send({
      attachment: {
        ...
        payload: {
          ...
          top_element_style: 'compact',
          elements: [{
            title: 'Creer un magazine',
            image_url: `${sslRootUrl}/images/square/add_photo.png`,
            subtitle: 'Selectionnez vos publications et réaliser votre magazine',
            default_action: {
              type: 'web_url',
            ...
            image_url: `${sslRootUrl}/images/square/collection.png`,
            subtitle: `Choisissez votre magazine et commandez le !`,
            default_action: {
              type: 'web_url',
              url: `${sslWebUrl}/print/order/${senderId}/`,
              messenger_extensions: true,
              webview_height_ratio: 'full',
            },
          }],
