...
module.exports = (app) => {
  ...
  app.get('/messenger/attach_thumb/:attachid', (req, res) => {
    const attachid = req.params.attachid;
    attach.attchFindOneById(attachid, (attachObj) => {
      res.contentType(attachObj.thumbnail_img.contentType);
      res.send(attachObj.thumbnail_img.data);
    });
  });
