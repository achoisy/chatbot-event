  ...
  valide: (eventId, attachId, callback) => {
    eventData.findByEventID(eventId, (eventDataObject) => {
      if (eventDataObject) {
        ...
        EventData.findOneAndUpdate({ _id: eventDataObject._id },
          {
            $set:
            {
              attach_to_validate: eventDataObject.attach_to_validate,
              valide_attach: eventDataObject.valide_attach,
            },
          },
          callback()
        );
        ...
        EventData.findOneAndUpdate({ _id: eventDataObject._id },
          {
            ...
            {
              attach_to_validate: eventDataObject.attach_to_validate,
              not_valide_attach: eventDataObject.not_valide_attach,
            },
          },
          callback()
        );
